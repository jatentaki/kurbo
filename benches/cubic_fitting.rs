//! Benchmark of cubic curve fitting
...
use kurbo::{CubicBez, Point, fitting::{ParamCurveFit, Constraint}};
...
#[bench]
fn bench_cubic_few_free(b: &mut Bencher) {
    use Constraint::Free;
    ...
    b.iter(|| CubicBez::fit(test::black_box(&FEW_POINTS), test::black_box(&constraints)))

}

#[bench]
fn bench_cubic_few_fixed(b: &mut Bencher) {
    use Constraint::Free;

    let constraints: [Constraint; 4] = [
        Free, Free, Free, Point::new(2., 4.).into()
    ];
...
#[bench]
fn bench_cubic_few_line(b: &mut Bencher) {
    use Constraint::Free;
...
//#[bench]
//fn bench_cubic_many(b: &mut Bencher) {
//    use Constraint::Free;
//
//    let constraints: [Constraint; 4] = [
//        Free, Free, Free, Free
//    ];
//
//    b.iter(|| CubicBez::fit(test::black_box(&MANY_POINTS), test::black_box(&constraints)))
//
//}
